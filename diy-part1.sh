...
echo "src-git garypang13 https://github.com/garypang13/openwrt-packages" >> feeds.conf.default 
#echo "src-git kenzokpackage https://github.com/kenzok8/small-package.git;19.07" >> feeds.conf.default
